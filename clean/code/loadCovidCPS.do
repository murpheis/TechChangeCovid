...
quietly infix                  ///
  ...
  byte    whyunemp    99-99    ///
  int     educ        100-102  ///
  byte    covidtelew  103-104  ///
  using `"./clean/input/covid_cps.dat"'
...
* save data as csv and dta
save  ./clean/output/covidCPS.dta, replace
export delimited using ./clean/output/covidCPS.csv, replace
